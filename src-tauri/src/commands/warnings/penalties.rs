...
use crate::{commands::replace_director::{ReplaceDirector, ResponseDirector}, state::ManagedApplicationState, templates::{error::screen_error, scoresheet::{artistic_row, errors_row, technical_row}}};
...
pub fn plus_error(
	...
	Ok(ReplaceDirector::with_target(
		"#penalties-errors", 
		rsx!{{Raw(errors_row(true, errors))}}.render()
	))
}
#[tauri::command]
pub fn sub_error(
...
pub fn plus_technical(
	...
	Ok(ReplaceDirector::with_target(
		"#penalties-technical", 
		rsx!{{Raw(technical_row(true, errors))}}.render()
	))
}
#[tauri::command]
pub fn sub_technical(
	...
	Ok(ReplaceDirector::with_target(
		"#penalties-technical", 
		rsx!{{Raw(technical_row(true, tech_penalties))}}.render()
	))
}
...
pub fn plus_artistic(
	...
	Ok(ReplaceDirector::with_target(
		"#penalties-artistic", 
		rsx!{{Raw(artistic_row(true, art_penalties))}}.render()
	))
}
#[tauri::command]
pub fn sub_artistic(
